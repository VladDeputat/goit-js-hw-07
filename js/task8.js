...
containerRef.setAttribute('style', 'display: flex;')
...
for (let i = 0; i < amount; i += 1){
   ...
   newBox.setAttribute('style', 'width: 30px; height: 30px; margin: 10px; background-color: tomato;');
...
renderBtnRef.addEventListener('click', createBoxes(4));
